...
<body class="host_version"> 
    ...
    <div id="overviews" class="section wb">
                                        ...
                                        <CENTER> <h2 style="font-family:cursivel; color:green;">MAKE YOUR DESICION </h2>
                                            </div></CENTER>
                    </div>
...
<strong>
	 ...
	 <td><font color="blue"><strong>CONFIGURATION</strong></td></font>
	  <tr><td> Image</td></tr>
	 <tr><td>Company Name</td></tr>
	 <tr><td>Phone Name</td></tr>
	 <tr><td>Display</td></tr>
	<tr><td>Front Mega Pixel</td></tr>
	<tr><td>Rear Mega Pixel</td></tr>
	<tr><td>Processor</td></tr>
	<tr><td>Price</td></tr>
	<tr><td>Sim</td></tr>
	<tr><td>Storage</td></tr>
	<tr><td>Color</td></tr>
...
<% 
	...
	String i[]=request.getParameterValues("select");
	for(int j=0;j<i.length;j++)
	{
		PreparedStatement ps=con.prepareStatement("select *from mobile where phoneid=?");
		ps.setString(1,i[j]);
		...
		ResultSet rs= ps.executeQuery(); 
		 if(rs.next())
		 {
			 %> 
			  ...
			  <td><font color="blue">PHONE <%=j+1 %></td>
			       </font>
			       			 			<tr><td><img width='250' height='200' src="displayimage.jsp?pid=<%= rs.getString(1)%>" alt="img"></img></td></tr>
			        ...
			        <tr><td><%=rs.getString(2) %></td></tr>
			 			 ...
			 			 <tr><td><%=rs.getString(9) %></td></tr>
			 			 <tr><td><%=rs.getString(10) %></td></tr>
			 			 <tr><td><%=rs.getString(11) %></td></tr>
			 			 <tr><td><%=rs.getString(12) %></td></tr>
...
{%>
	<h2><center><font color="red">SELECT ANY 3 OR 2 PHONES FOR COMPARISON</font></center></h2>
	<% 
}
%>
</tr>
