...
%>
    	...
    	<tr>
    	        <tr><td><strong>Name</strong></td>&nbsp; &nbsp;<td>:</td>&nbsp; &nbsp;<td><%= rs.getString(1) %></td></tr>
    	    	<tr><td><strong>Username</strong></td>&nbsp; &nbsp;<td>:</td>&nbsp; &nbsp;<td><%= rs.getString(2) %></td></tr>
    	    	<tr><td><strong>Place</strong></td>&nbsp; &nbsp;<td>:</td>&nbsp; &nbsp;<td><%= rs.getString(5) %></td></tr>
    	        <tr><td><strong>Phone number</strong></td>&nbsp; &nbsp;<td>:</td>&nbsp; &nbsp;<td><%= rs.getString(7) %></td></tr>
    	        <tr><td><strong>E-mail</strong></td>&nbsp; &nbsp;<td>:</td>&nbsp; &nbsp;<td><%= rs.getString(6) %></td></tr>
    	         <tr><td colspan="3"><center><a href="changepwd.jsp?uname=<%=rs.getString(2)%>"><u>Edit profile</u></a></center></td>
