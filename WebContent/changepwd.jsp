    ...
    <div id="support" class="section wb">
        <div class="container">
            <div class="section-title text-center">
                <h3 style="font-family:serif;color:darkviolet">MY PROFILE</h3>
            </div><!-- end title -->
...
<form action="chagpwd1.jsp">
<%@ page import ="java.io.*"%>
<%@ page import="java.sql.*"%>
<br>
 <table class="center"><center>
<%
...
try
{
 ...
 PreparedStatement pst=con.prepareStatement("select * from usereg where username=?");
 ...
 if(rs.next())
 {
	 ...
	 %>
		 <center>
		 <tr><td><strong>Name</strong></td><td><input type="text" name="name" value=<%=rs.getString(1) %>></td></tr>
		 <tr><td><strong>Username</strong></td><td><input type="text" name="uname" value=<%=rs.getString(2)%>></td></tr>
		 <tr><td><strong>Password</strong><td> <input type="text" name="pwd" value=<%=rs.getString(3) %>></td></tr><br>
		 <tr><td><strong>Place</strong> </td><td><input type="text" name="place" value=<%=rs.getString(5)%>></td></tr>
		 <tr><td><strong>E-mail</strong>  </td><td><input type="text" name="mail" value=<%=rs.getString(6)%>></td></tr>
		 <tr><td><strong>Phone number</strong>  </td><td><input type="text" name="phn" value=<%=rs.getString(7)%>></td></tr>
		 <tr><td colspan="2"><center><button type="submit">Edit</button></td></tr></center>
		 </center>
		 <%
