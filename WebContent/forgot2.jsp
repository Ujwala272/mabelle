...
try
{
	...
	Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe", "june","june");
	 PreparedStatement pst=con.prepareStatement("update usereg set password=?,renter=? where username=?");
	 ...
	 %>
	 <h1><center><a href="login.html" style="color:orange;font-size:20px">Login </a></center></h1>
	 <%
	 }
	 else
		 %>
		 <h1><center style="color:orange;">error</center></h1>
<%
con.close();
