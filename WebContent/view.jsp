...
<body class="host_version"> 
	...
	<div id="support" class="section wb">
            ...
            <h1><strong style="color:darkviolet;">VIEW PHONES</strong></h1>
            </div><!-- end title -->
    </div><!-- end section -->
...
<td><strong>color</strong></td><td><strong>features</strong></td><td><strong>Image</strong></td><td><strong>select</strong></td><td><strong>select</strong></td>
</tr>
...
%>
    	<tr>
    	    	...
    	    	<td><a href="delete.jsp?phoneid=<%= rs.getString(1) %>">Delete</a></td>
    	    	<td><a href="edit.jsp?phoneid=<%= rs.getString(1) %>">Edit</a></td></tr>
